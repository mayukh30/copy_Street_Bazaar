      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-blue-400">FreshMart</h3>
            <p className="text-gray-300">
              Your trusted partner for fresh, quality products delivered right to your doorstep.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white">Orders</a></li>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-300">123 Fresh Street, City, State</span>
              </div>
            </div>
          </div>
        </div>
